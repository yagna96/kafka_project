...
# group and  offset rest are new in consumer side 
#consumer side is used for desrialising the data 
# offset reset decides from where the data can be consumed , latest or earliest 
kafka_config = {
...
# same schema registry as producer 
